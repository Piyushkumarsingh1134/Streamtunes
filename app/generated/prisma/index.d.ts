...
export namespace Prisma {
  ...
  */
  ...
  export type StreamOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "type" | "url" | "extractId" | "active" | "upvotes" | "userId", ExtArgs["result"]["stream"]>
  ...
  interface StreamFieldRefs {
    ...
    readonly extractId: FieldRef<"Stream", 'String'>
  ...
  export type StreamWhereInput = {
    ...
    extractId?: StringFilter<"Stream"> | string
  ...
  export type StreamScalarWhereWithAggregatesInput = {
    ...
    extractId?: StringWithAggregatesFilter<"Stream"> | string
